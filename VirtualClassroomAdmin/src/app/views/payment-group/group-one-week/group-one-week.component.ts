...
@Component({
  selector: 'app-group-one-week',
  templateUrl: './group-one-week.component.html',
  styleUrls: ['./group-one-week.component.css']
})
export class GroupOneWeekComponent implements OnInit {
  ...
  getAllrecords(pagination) {
    ...
    let request =
      { typeOfLesson: 'group', typeOfTransaction: 3, skip: this.skip, limit: this.limit }
    this.busy =
