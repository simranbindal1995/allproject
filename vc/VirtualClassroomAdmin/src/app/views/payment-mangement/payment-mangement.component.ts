...
@Component({
  ...
  styleUrls: ['./payment-mangement.component.css']
})
export class PaymentMangementComponent implements OnInit {
  ...
  getAllrecords(pagination) {
    ...
    let request =
      { typeOfLesson: 'one-one', typeOfTransaction: 1, skip: this.skip, limit: this.limit }
    this.busy =
