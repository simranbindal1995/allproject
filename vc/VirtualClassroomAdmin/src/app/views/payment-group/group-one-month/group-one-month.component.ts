...
@Component({
  selector: 'app-group-one-month',
  templateUrl: './group-one-month.component.html',
  styleUrls: ['./group-one-month.component.css']
})
export class GroupOneMonthComponent implements OnInit {
  ...
  getAllrecords(pagination) {
    ...
    let request =
      { typeOfLesson: 'group', typeOfTransaction: 2, skip: this.skip, limit: this.limit }
    this.busy =
